...
# Folder
folder<-"F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Research/Data/"
# Data creation
library(readxl)
...
write.csv(results_svl_geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_svl_geckos.csv")
...
write.csv(results_svl_lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_svl_lizards.csv")
...
write.csv(results_svl_skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_svl_skinks.csv")
...
write.csv(results_geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_geckos.csv")
...
write.csv(results_lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_lizards.csv")
...
write.csv(results_skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/results_skinks.csv")
...
write.csv(results_bodycond_geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_bodycond_geckos.csv")
...
write.csv(results_bodycond_lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_bodycond_lizards.csv")
contrast(emmeans(model_bodycond,~snakes|sex,adjust="fdr"))
contrast(emmeans(model_bodycond,~sex|snakes,adjust="fdr"))
...
write.csv(results_bodycond_skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_bodycond_skinks.csv")
contrast(emmeans(model_bodycond,~snakes|sex,adjust="fdr"))
contrast(emmeans(model_bodycond,~sex|snakes,adjust="fdr"))
...
write.csv(results_prevalence_geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_prevalence_geckos.csv")
...
write.csv(results_abundance_geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_abundance_geckos.csv")
...
write.csv(results_prevalence_lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_prevalence_lizards.csv")
...
write.csv(results_abundance_lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Tables_results/table_abundance_lizards.csv")
...
write.csv(lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_morphology/lizards.csv")
...
write.csv(skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_morphology/skinks.csv")
write.csv(skinks_snakes,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_morphology/skinks_snakes.csv")
...
write.csv(geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_morphology/geckos.csv")
...
write.csv(lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_condition/lizards.csv")
write.csv(lizards_snakes,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_condition/lizards_snakes.csv")
...
write.csv(skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_condition/skinks.csv")
...
write.csv(geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Figures/Fig_condition/geckos.csv")
```
...
write.csv(lizards,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Table S1/lizards.csv")
write.csv(skinks,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Table S1/skinks.csv")
write.csv(geckos,file="F:/Research/Projects/A_2019_CSIC_EvoImpLamp/Communication/Paper/Table S1/geckos.csv")
```
